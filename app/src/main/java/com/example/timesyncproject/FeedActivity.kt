...
import com.example.timesyncproject.databinding.ActivityFeedBinding
...
class FeedActivity : AppCompatActivity() {
        ...
        studyTimer = object : CountDownTimer(studyMinute!!.toLong() + 500,1000) {
            ...
            override fun onFinish() {
                if(mRound < roundCount!!){
                    ...
                    clearAttribute()
                    binding.tvStatus.text = "The timer has finished"
                }
            }
        }.start()
    }
    ...
    private fun clearAttribute() {
        ...
        binding.ivStop.setImageResource(R.drawable.baseline_play_24)
        binding.progressBar.progress = 0
