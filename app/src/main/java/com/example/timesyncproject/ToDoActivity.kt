...
import com.example.timesyncproject.databinding.ActivityToDoBinding
...
class ToDoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gridLayoutManager = GridLayoutManager(this@ToDoActivity, 1)
        ...
        dataList = ArrayList()
        adapter = MyAdapter(this@ToDoActivity, dataList)
        binding.recyclerView.adapter = adapter
        databaseReference = FirebaseDatabase.getInstance().getReference("Todo List")

        // Perform a null check before adding the ValueEventListener
